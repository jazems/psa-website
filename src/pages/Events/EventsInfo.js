...
import CultureShow from "../../assets/events/culture_show.png"
import MKR from "../../assets/events/mkrplaceholder.jpeg"
import Seminar from "../../assets/events/pakistaniseminar.jpeg"

function EventsInfo() {
    return ( 
        <div className={styles.container}>
        <div className={styles.gridItem}>
            <img src={CultureShow} alt="" />
        </div>
       <div className={styles.gridItem}>
